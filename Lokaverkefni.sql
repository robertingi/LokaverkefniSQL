...
create type kt as table
(
	kt char(10)
	
)
create type streets as table
(
	heiti_nefnifall varchar(75) unique,
	postnumer int,
	heiti_thagufall varchar(75)
)
...
--declare @kk int
--declare @kvk int
--set @kk = ( @karlar / 100 ) * @fjoldi
--set @kvk = ( @konur / 100 ) * @fjoldi
declare @maxid int
declare strakar cursor
for
	select * from strakaFornofn
...
@nafn varchar(75)
as begin
select id, kt, nafn from nafnogkt where nafn like @nafn
end
...
exec StelpuNofn
exec nofn 10, 10, 17, 67 -- Fjöldi stráka, fjöldi stelpna, minnsti aldur, mesti aldur

delete from stelpurFornofn
delete from strakaFornofn
exec eydaurnafnogkt
exec finnanafn 'Róbert%'
